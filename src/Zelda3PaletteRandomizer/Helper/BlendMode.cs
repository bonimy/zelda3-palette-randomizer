...
namespace Maseya.Helper
{
    ...
    public enum BlendMode
    {
        ...
        /// effect to <see cref="Multiply"/>. The result is a brighter
        /// picture.
        /// </summary>
        Screen,
        ...
        /// modes. Equivalent to <see cref="Overlay"/>, but with the bottom
        /// and top images swapped.
        /// </summary>
        HardLight,
        ...
        /// <summary>
        /// Creates a pixel that retains the smallest components of the
        ...
        /// <summary>
        /// Replaces the saturation of the top layer with the saturation of
        /// the bottom layer.
        /// </summary>
        Saturation,

        /// <summary>
        /// Replaces the luminosity of the top layer with the luminosity of
        /// the bottom layer.
        /// </summary>
        Luminosity,
